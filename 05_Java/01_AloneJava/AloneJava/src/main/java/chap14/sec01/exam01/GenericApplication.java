...
//      TODO: 1) 아래 에러
//        ArrayList<Product> tvArrayList = new ArrayList<Tv>(); <- 안됨

//      TODO: 2) productArrayList : 부모 클래스 배열에 자식 넣기 ?
        productArrayList.add(new Tv()); // Ok
        productArrayList.add(new Audio()); // Ok
