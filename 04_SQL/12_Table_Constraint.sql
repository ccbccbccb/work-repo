...
VALUES(NULL,NULL,NULL,'010-123-4567','SEOUL'); -- 기본키로 인해 에러발생
...
CREATE TABLE EMP_SECOND(
    ENO NUMBER(4) CONSTRAINT PK_EMP_SECOND_ENO PRIMARY KEY -- 여기다 쓰면 컬럼명 생략가능
   ,ENAME VARCHAR2(10)
   ,JOB VARCHAR2(9)
...
-- 5) DEFAULT 제약조건 : NULL 값이 INSERT 될떄 기본적으로 다른 값으로 생성하는 제약조건
CREATE TABLE EMP_SECOND(
    ENO NUMBER(4) CONSTRAINT PK_EMP_SECOND_ENO PRIMARY KEY
    ,ENAME VARCHAR(10)
