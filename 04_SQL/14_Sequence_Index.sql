...
-- 기본키(PK) : 중복방지 + NULL 값 방지 + 자동인덱스생성

-- 예제 3) 사이트에서 조회시 이름검색이 많은데 속도가 느리다고 한다.(EMPLOYEE)
...
-- 속도 느림 대상 SQL 문
SELECT * FROM EMPLOYEE WHERE ENAME LIKE 'SCOTT%'; -- 이부분이 INDEX를 만들곳
