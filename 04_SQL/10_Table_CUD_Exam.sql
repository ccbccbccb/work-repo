...
VALUES(1, 'CCB', 'STUDENT', NULL, SYSDATE, 2700, 230, 10);
...
-- 참고) INSERT 시 EMP_INSERT(컬럼명 ...) : 컬럼명 생략가능 (모든 데이터를 INSERT 할떄만 가능)

INSERT INTO EMP_INSERT(ENO, ENAME, JOB, MANAGER, HIREDATE, SALARY, COMMISSION, DNO)
VALUES(2, 'NHH', 'STUDENT', NULL, TO_DATE('23/09/12', 'YYYY-MM-DD HH24:MI:SS'), 2700, 230, 10);
